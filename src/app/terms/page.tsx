      ...
      <section className="bg-gradient-to-br from-primary-bg via-secondary-bg to-neutral-dark pb-8 md:pb-12 pt-0 prevent-horizontal-scroll">
        <div className="container-custom text-center">
          <div className="inline-block mb-4 md:mb-6">
            <span className="text-xs md:text-sm font-semibold text-accent-teal uppercase tracking-wider px-3 md:px-4 py-2 rounded-full bg-accent-teal/10 border border-accent-teal/30">
              Legal
            </span>
          </div>
        ...
        <div className="container-custom max-w-4xl">
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="bg-secondary-bg p-4 md:p-6 lg:p-8 rounded-2xl md:rounded-3xl border border-border-gray">
              <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-3 md:mb-4">Acceptance of Terms</h2>
            ...
            <div className="bg-secondary-bg p-4 md:p-6 lg:p-8 rounded-2xl md:rounded-3xl border border-border-gray">
              <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-3 md:mb-4">Use License</h2>
              <div className="text-text-secondary space-y-4">
            ...
            <div className="bg-secondary-bg p-4 md:p-6 lg:p-8 rounded-2xl md:rounded-3xl border border-border-gray">
              <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-3 md:mb-4">Product Information</h2>
              <div className="text-text-secondary space-y-4">
            ...
            <div className="bg-secondary-bg p-4 md:p-6 lg:p-8 rounded-2xl md:rounded-3xl border border-border-gray">
              <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-3 md:mb-4">Service Terms</h2>
              <div className="text-text-secondary space-y-4">
            ...
            <div className="bg-secondary-bg p-4 md:p-6 lg:p-8 rounded-2xl md:rounded-3xl border border-border-gray">
              <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-3 md:mb-4">Limitation of Liability</h2>
              <div className="text-text-secondary space-y-4">
            ...
            <div className="bg-secondary-bg p-4 md:p-6 lg:p-8 rounded-2xl md:rounded-3xl border border-border-gray">
              <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-3 md:mb-4">Governing Law</h2>
              <div className="text-text-secondary space-y-4">
            ...
            <div className="bg-secondary-bg p-4 md:p-6 lg:p-8 rounded-2xl md:rounded-3xl border border-border-gray">
              <h2 className="text-xl md:text-2xl font-bold text-text-primary mb-3 md:mb-4">Contact Information</h2>
              <div className="text-text-secondary space-y-4">

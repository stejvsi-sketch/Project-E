  ...
  ({ className, label, error, ...props }, ref) => {
    return (
      <div className="w-full">
        ...
        <input
          className={cn(
            'flex h-11 w-full rounded-xl border border-border-subtle bg-white/50 backdrop-blur-sm px-4 py-2.5 text-base transition-all',
            'text-text-heading placeholder:text-text-muted/60',
